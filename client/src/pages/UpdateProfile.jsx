...
const UpdateProfile = () => {
  ...
  return (
    <>
      <div
        className={`max-w-md mx-auto mt-8 p-6 rounded-lg shadow-lg transition-colors duration-500 ${theme === "light" ? "bg-white text-gray-900" : "bg-gray-900 text-gray-100"
          }`}
      >
        ...
        <div className="flex flex-col items-center mb-6">
          <div
            className={`w-24 h-24 rounded-full overflow-hidden border-4 transition-colors duration-500 ${theme === "light" ? "border-blue-500" : "border-blue-400"
              } shadow-md`}
          >
            {imagePreview ? (
              <img
          ...
          <label
            htmlFor="imageUpload"
            className={`mt-2 cursor-pointer text-sm font-medium transition-colors duration-300 hover:underline ${theme === "light"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              disabled
              value={user?.fullName || ""}
              className={`w-full rounded-md border px-3 py-2 text-sm transition-colors duration-500
          ...
          <div>
            ...
            <textarea
              ...
              className={`w-full rounded-md border px-3 py-2 text-sm transition-colors duration-500 resize-none
            focus:outline-none focus:ring-2 ${theme === "light"
                  ? "border-gray-300 focus:ring-blue-500 bg-white text-gray-900"
                  : "border-gray-600 focus:ring-blue-400 bg-gray-800 text-gray-100"
                }`}
